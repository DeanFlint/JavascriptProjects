...
let betterWords = storyWords.filter( word => unnecessaryWords.includes(word) === false)
...
console.log("Really wordCount: " + reallyCount)
console.log("Very wordCount: " + veryCount)
console.log("Basically wordCount: " + basicallyCount)
